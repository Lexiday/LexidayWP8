...
namespace Lexiday.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        ...
        public async void LoadData()
        {
            ...
            foreach(ParseObject word in results)
            {
                this.Items.Add(new ItemViewModel() { ID = i.ToString(), LineOne = word.Get<string>("word"), LineThree = word.Get<string>("definition"), LineTwo = word.Get<string>("synops") });
                i++;
            }
